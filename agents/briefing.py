...
LEGAL: 추천/매수·매도/목표가/단정 금지. 관찰·참고·중립 해석만. 본문 1줄 압축 면책.
"""
...
from agents.marketer import COMPACT_DISCLAIMER, ThreadsPost, assemble_post
