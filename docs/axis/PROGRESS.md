...
> - [`docs/PROGRESS_2026-07-13.md`](../PROGRESS_2026-07-13.md) — **Pro 한정 할인가**(월 39,000→29,000 26%↓ / 연 398,000→319,000 20%↓, 정가 취소선·할인율 배지). LS variant 실가격 검증 + 연 할인 "2개월→1개월" 문구 정정 + 할인가 기준 손익분기 재계산(상한 헤비유저 마진 거의 0)
